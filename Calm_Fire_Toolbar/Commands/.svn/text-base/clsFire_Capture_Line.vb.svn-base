...
<System.Runtime.InteropServices.ProgID("CALM_FireTools.clsFire_Capture_Line")> _ 
<VB6Object("CALM_FireTools.clsFire_Capture_Line")> _
Public Class clsFire_Capture_Line
	Implements SystemUI.ICommand
' UPGRADE_INFO (#0501): The 'clsFire_Capture_Line' member isn't used anywhere in current application.
...
ErrorHandler:
	...
	Private ReadOnly Property ICommand_Tooltip() As String Implements SystemUI.ICommand.Tooltip
		Get
			...
			' TODO: Add your implementation here
			Return "Create Fire Line Features"
...
ErrorHandler:
	...
	Private ReadOnly Property ICommand_Bitmap() As Integer Implements SystemUI.ICommand.Bitmap
		Get
			...
			' TODO: Add your implementation here
			Return GetPictureHandle6(frmImages.new_line.Picture)
...
ErrorHandler:
	...
	Private Sub ICommand_OnClick() Implements SystemUI.ICommand.OnClick
        ...
        pFeatLayer = modFire_Tools.Get_Fire_Line_Layer()
        ...
        For taskcount = 0 To peditor.TaskCount - 1
            ...
            If pEditTask.Name = "CALM Fire Line" Then
