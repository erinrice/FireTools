...
'<System.Runtime.InteropServices.ProgID("CALM_FireTools.clsFire_Legend_Restorer")> _ 
'<VB6Object("CALM_FireTools.clsFire_Legend_Restorer")> _
'Public Class clsFire_Legend_Restorer
'	Implements SystemUI.ICommand
'' UPGRADE_INFO (#0501): The 'clsFire_Legend_Restorer' member isn't used anywhere in current application.
...
'			' TODO: Add your implementation here
'			Return "Restore Legend to original state"
...
'			' TODO: Add your implementation here
'			Return GetPictureHandle6(frmImages.legend_restorer.Picture)
