...
<System.Runtime.InteropServices.ProgID("CALM_FireTools.clsFire_Email_GDB")> _ 
<VB6Object("CALM_FireTools.clsFire_Email_GDB")> _
Public Class clsFire_Email_GDB
	Implements SystemUI.ICommand
' UPGRADE_INFO (#0501): The 'clsFire_Email_GDB' member isn't used anywhere in current application.
...
ErrorHandler:
	...
	Private ReadOnly Property ICommand_Tooltip() As String Implements SystemUI.ICommand.Tooltip
		Get
			...
			' TODO: Add your implementation here
			Return "Email Fire Incident Geodatabase"
...
ErrorHandler:
	...
	Private ReadOnly Property ICommand_Bitmap() As Integer Implements SystemUI.ICommand.Bitmap
		Get
			...
			' TODO: Add your implementation here
			Return GetPictureHandle6(frmImages.email_gdb.Picture)
...
ErrorHandler:
	...
	Private Sub CreateEmail()
		...
		If Fileexists(foldername & myIncidentInfo.IncidentRegionEx & myIncidentInfo.IncidentNumber & "_" & mydatestring & "_" & mytimestring & ".mdb") Then
			fsoSysObj = New VB6FileSystemObject()
			fsoSysObj.DeleteFile(foldername & myIncidentInfo.IncidentRegionEx & myIncidentInfo.IncidentNumber & "_" & mydatestring & "_" & mytimestring & ".mdb")
		End If
		
		fsoSysObj = New VB6FileSystemObject()
		fsoSysObj.CopyFile(myIncidentInfo.IncidentWorkspace.PathName, foldername & myIncidentInfo.IncidentRegionEx & myIncidentInfo.IncidentNumber & "_" & mydatestring & "_" & mytimestring & ".mdb")
		
		modFire_Tools.Update_Log_Email(foldername & myIncidentInfo.IncidentRegionEx & myIncidentInfo.IncidentNumber & "_" & mydatestring & "_" & mytimestring & ".mdb", MyDay & "/" & MyMonth & "/" & MyYear, myhour & "/" & myminute, "Incident Geodatabase")
		...
		With objMail
			...
			Next
			.To = emailstring
			.Subject = myIncidentInfo.IncidentRegionEx & "::" & myIncidentInfo.IncidentNumber & " Incident Geodatabase - " & mydatestring & "_" & mytimestring
		...
		objMail.Attachments.Add(foldername & myIncidentInfo.IncidentRegionEx & myIncidentInfo.IncidentNumber & "_" & mydatestring & "_" & mytimestring & ".mdb")
		objMail.Display()
