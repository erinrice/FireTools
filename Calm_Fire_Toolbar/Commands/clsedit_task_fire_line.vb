...
<ComClass(clsedit_task_fire_line.ClassId, clsedit_task_fire_line.InterfaceId, clsedit_task_fire_line.EventsId), _
System.Runtime.InteropServices.ProgId("CALM_FireTools.clsedit_task_fire_line")> _
<VB6Object("CALM_FireTools.clsedit_task_fire_line")> _
Public Class clsedit_task_fire_line
...
#Region "COM GUIDs"
    ...
    Public Const ClassId As String = "5090319f-5c3c-403a-aa8c-7181dd038915"
    Public Const InterfaceId As String = "66b091fb-daa1-4696-98f7-d50a0c96c4e2"
    Public Const EventsId As String = "59f9f7ae-e6f5-419c-b157-85713cd86462"
#End Region

    ' UPGRADE_INFO (#0501): The 'clsedit_task_fire_line' member isn't used anywhere in current application.

    '******************************************************************************************************************
    'Date: 06 / 06 / 06
    'Author: Nathan Eaton, CALM
    'Description: Edit task for capturing Fire Lines
    'Called By
    'Calls
    'Accepts
    'Returns
    ...
    Public Sub IEditTask_Activate(ByVal Editor As ESRI.ArcGIS.Editor.IEditor, ByVal oldTask As ESRI.ArcGIS.Editor.IEditTask) Implements Editor.IEditTask.Activate
        ...
        m_pEditSketch.GeometryType = ESRI.ArcGIS.Geometry.esriGeometryType.esriGeometryPolyline
        ...
        myForm.ShowDialog()
        m_datestring = myForm.txtDate.Text 'InputBox("Enter Effective From time", "Effective From", MyDatetext)
    ...
    Public Sub IEditTask_OnFinishSketch() Implements Editor.IEditTask.OnFinishSketch
        ...
        Dim myForm As New frmFire_Line
        ...
        m_pEditor.StopOperation("CALM Fire Line")
