...
<System.Runtime.InteropServices.ProgID("CALM_FireTools.clsFire_Incident_Menu")> _ 
<VB6Object("CALM_FireTools.clsFire_Incident_Menu")> _
Public Class clsFire_Incident_Menu
	Implements SystemUI.IMenuDef
' UPGRADE_INFO (#0501): The 'clsFire_Incident_Menu' member isn't used anywhere in current application.
...
ErrorHandler:
	...
	Private Sub IMenuDef_GetItemInfo(ByVal pos As Integer, ByVal itemDef As ESRI.ArcGIS.SystemUI.IItemDef) Implements SystemUI.IMenuDef.GetItemInfo
		...
		Select Case pos
			Case 0
				itemDef.ID = "CALM_FireTools.clsFire_Create_Incident"
			Case 1
				itemDef.ID = "CALM_FireTools.clsFire_open_Incident"
		End Select
