...
<System.Runtime.InteropServices.ProgID("CALM_FireTools.clsFire_Email_View")> _ 
<VB6Object("CALM_FireTools.clsFire_Email_View")> _
Public Class clsFire_Email_View
	Implements SystemUI.ICommand
' UPGRADE_INFO (#0501): The 'clsFire_Email_View' member isn't used anywhere in current application.
...
ErrorHandler:
	...
	Private ReadOnly Property ICommand_Bitmap() As Integer Implements SystemUI.ICommand.Bitmap
		Get
			...
			' TODO: Add your implementation here
			Return GetPictureHandle6(frmImages.email_view.Picture)
...
ErrorHandler:
	...
	Private Sub CreateEmail()
		...
		Dim filename As String = foldername & myIncidentInfo.IncidentRegionEx & myIncidentInfo.IncidentNumber & "_" & mydatestring & "_" & mytimestring & "_View.jpg"
		
		modFire_Tools.ExportActiveView_jpg(filename)
		...
		modFire_Tools.Update_Log_Email(filename, MyDay & "/" & MyMonth & "/" & MyYear, myhour & "/" & myminute, "ViewFrame")
		...
		With objMail
			...
			.Subject = myIncidentInfo.IncidentRegionEx & "::" & myIncidentInfo.IncidentNumber & " Map - " & mydatestring & "_" & mytimestring
		...
		If Fileexists(Replace(filename, ".jpg", ".jgw")) Then
			objMail.Attachments.Add(Replace(filename, ".jpg", ".jgw"))
		End If
