...
<System.Runtime.InteropServices.ProgID("CALM_FireTools.clsFire_Symbols")> _ 
<VB6Object("CALM_FireTools.clsFire_Symbols")> _
Public Class clsFire_Symbols
	Implements SystemUI.ICommand
' UPGRADE_INFO (#0501): The 'clsFire_Symbols' member isn't used anywhere in current application.
...
ErrorHandler:
	...
	Private ReadOnly Property ICommand_Bitmap() As Integer Implements SystemUI.ICommand.Bitmap
		Get
			...
			' TODO: Add your implementation here
			Return GetPictureHandle6(frmImages.symbols.Picture)
...
ErrorHandler:
	...
	Private Sub ICommand_OnClick() Implements SystemUI.ICommand.OnClick
        ...
        Dim myForm As New frmSymLbl
        myForm.ShowDialog()
        'frmSymLbl.Show(VBRUN.FormShowConstants.vbModal)
